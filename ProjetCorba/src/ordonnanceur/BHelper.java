...
{
  private static String  _id = "IDL:B:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_interface_tc (BHelper.id (), "B");
    }
    return __typeCode;
  }
  ...
  public static B narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    ...
    else
    {
      ...
      _BStub stub = new _BStub ();
      stub._set_delegate(delegate);
      return stub;
    }
  }

  public static B unchecked_narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    else if (obj instanceof B)
